...
model=pickle.load(open("D:/SATHI/Sathi/client/src/components/Mlpage/model.pkl",'rb'))
...
def predict():
    ...
    image_path = "D:/SATHI/Sathi/client/src/components/Mlpage/images"+imagefile.filename
